...
function WhatsAppButton({ telefone = "+244923000000", mensagem = "Olá! Gostaria de mais informações sobre o Mercado Yangue." }) {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 bg-green-600 text-white p-4 rounded-full shadow-lg hover:bg-green-700 transition-all duration-300 z-50 flex items-center justify-center gap-2 group"
